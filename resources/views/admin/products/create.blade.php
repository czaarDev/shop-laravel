        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.products.store") }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control mask_money {{ $errors->has('price') ? 'is-invalid' : '' }}" type="text" name="price" id="price" value="{{ old('price', '') }}" required>
                    @if($errors->has('price'))
                        <div class="invalid-feedback">
                            {{ $errors->first('price') }}
                        </div>
                    ...
                    @foreach(\App\Enums\PaymentMethod::cases() as $item)
                        <div class="form-check {{ $errors->has('attributes[payment_methods]') ? 'is-invalid' : '' }}">
                            <input type="checkbox"
                                   ...
                                   value="{{ $item->value }}"
                                   @checked(old('attributes[payment_methods]', $item->value))
                            />
                ...
                <div class="form-group div-maximum_number_of_installments">
                    ...
                    <input type="text"
                           ...
                           value="{{ old('attributes[maximum_number_of_installments]', 12) }}"
                           maxlength="2"
