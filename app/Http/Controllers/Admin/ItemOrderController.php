...
class ItemOrderController extends Controller
{
    public function index()
    {
        ...
        $itemOrders = ItemOrder::with(['product'])->get();
    ...
    public function create()
    {
        ...
        return view('admin.itemOrders.create', compact('products'));
    }
    ...
    public function edit(ItemOrder $itemOrder)
    {
        ...
        $itemOrder->load('product');

        return view('admin.itemOrders.edit', compact('itemOrder', 'products'));
    }
