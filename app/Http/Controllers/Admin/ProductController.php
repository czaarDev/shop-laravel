...
class ProductController extends Controller
{
    ...
    public function index()
    {
        ...
        $products = Product::with(['categories', 'media'])->latest('id')->get();
    ...
    public function store(StoreProductRequest $request)
    {
        ...
        foreach ($request->input('photo', []) as $item) {
            $product->addMedia(storage_path('tmp/uploads/' . basename($item)))->toMediaCollection('photo');
        }
