...
class ContentPageController extends Controller
{
    ...
    public function index()
    {
        ...
        $contentPages = ContentPage::with(['categories', 'media'])->get();

        $content_categories = ContentCategory::get();

        return view('admin.contentPages.index', compact('contentPages', 'content_categories'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.contentPages.create', compact('categories'));
    }
    ...
    public function edit(ContentPage $contentPage)
    {
        ...
        $contentPage->load('categories');

        return view('admin.contentPages.edit', compact('categories', 'contentPage'));
    }
